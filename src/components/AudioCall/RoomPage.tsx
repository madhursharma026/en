...
// import type { RootStackParamList } from '../../navigation/authNavigation';
...
export default function RoomPage({navigation, route}: any){
...
//   const url = 'wss://audio-chat-nextjs-eqg35w5o.livekit.cloud'
//   const token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..WAOVv-KE6n0PZOwQuplR4xEt2xVU-oODgDnEGXZlvKM'
