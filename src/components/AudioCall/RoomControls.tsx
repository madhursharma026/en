    ...
    <View style={[style, styles.container]}>
      ...
      <Pressable
        ...
        <Image
          ...
          source={{ uri: 'https://play-lh.googleusercontent.com/DFdH4bDjmcbBxNnMGpnIcbYtQre1w_v3wc92BZQJfrViFJiqvPDvw02zf3wyy3osBac=w240-h480-rw' }}
        />
      </Pressable>
      ...
      <Pressable  onPress={handleOk}>
        <Image
          ...
          source={{ uri: 'https://cdn-icons-png.flaticon.com/512/3530/3530664.png' }}
        />
      </Pressable>
      ...
      <Pressable
        ...
        }} style={{ height: 25, width: 25, backgroundColor: 'white', borderRadius: 50 }}
      >
        {/* <Image
          style={styles.icon}
        ...
        <Image
          ...
          source={{ uri: 'https://static.thenounproject.com/png/870483-200.png' }}
        />
      </Pressable>
